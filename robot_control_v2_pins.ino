...
/* ============================================================
   ...
   Bluetooth module (HC-05 / HC-06):
     Bluetooth TXD  -> Arduino pin 2  (bluetooth RX)
     Bluetooth RXD  -> Arduino pin 3  (bluetooth TX) 
   ...
   L298N Motor Driver:
     IN1 -> Arduino pin 5   (Left motor direction A)
     IN2 -> Arduino pin 6   (Left motor direction B)
     IN3 -> Arduino pin 7   (Right motor direction A)
     IN4 -> Arduino pin 8   (Right motor direction B)
     ENA -> Arduino pin 9   (Left motor speed, PWM ~)
     ENB -> Arduino pin 10  (Right motor speed, PWM ~)
